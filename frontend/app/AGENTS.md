...
- `/worklist` may expose local imaging import and imported-study inspection controls when backend platform config enables them; imports, asset summaries, and preview thumbnails must go through the backend local imaging contract.
