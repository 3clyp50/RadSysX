...
- Local runnable desktop app:
  ...
  - Evidence: `desktop:smoke:import` now fetches backend technical analysis results for imported DICOM, NIFTI, PNG, JPEG, and TIFF assets through the local bridge.
