...
- `src/client.ts` owns the browser client for backend local imaging import and imported-study asset summaries, including relative-path preservation for folder/DICOMDIR uploads from browser `webkitRelativePath` and Electron `radsysxRelativePath`.
