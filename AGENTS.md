...
- Fast local desktop path:
  ...
  - This path validates local login, native local file/folder selection, local imaging import, imported-study asset summaries, worklist, launch, workspace, report, AI job, and audit contracts without Docker.
